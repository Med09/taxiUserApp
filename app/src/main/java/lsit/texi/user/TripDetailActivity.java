...
//                });
    ...
    void checkLogin(){
        CallWebService.getInstance(TripDetailActivity.this,true).hitJSONObjectVolleyWebServiceforPost(Request.Method.POST, Url.loginUrl, addJsonObjects(), false, new CallBackInterface() {
            @Override
