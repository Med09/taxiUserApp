...
import static lsit.texi.user.utils.Common.*;
...
//        });
    ...
    void checkLogin(){
        CallWebService.getInstance(LoginActivity.this,true).hitJSONObjectVolleyWebServiceforPost(Request.Method.POST, Url.loginUrl, addJsonObjects(), false, new CallBackInterface() {
            @Override
