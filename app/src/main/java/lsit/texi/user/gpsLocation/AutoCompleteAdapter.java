package lsit.texi.user.gpsLocation;
...
public class AutoCompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList autocomplete(String input,Activity activity) {
        ...
        StringBuilder jsonResults = new StringBuilder();
            ...
            String locationUrl = "";
            try {
                locationUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyDcN2GmXc_ALDyojmUMqjUVvEjeRElgSHw&input=" + URLEncoder.encode(input, "UTF-8");
