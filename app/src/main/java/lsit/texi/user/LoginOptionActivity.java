...
//                                });
    ...
    void checkLogin(){
        CallWebService.getInstance(LoginOptionActivity.this,true).hitJSONObjectVolleyWebServiceforPost(Request.Method.POST, Url.loginUrl, addJsonObjects(), false, new CallBackInterface() {
            @Override
