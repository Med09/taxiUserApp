...
import lsit.texi.user.utils.AllTripFeed;
...
public class BookingDetailActivity extends AppCompatActivity implements FB_Callback {
    ...
    public void ShareFacebookLink(final String Description){
        ...
        if(loggedIn) {
            ...
            shareLink.postStatusUpdate("LSIT Solutions", Description, Url.AppLogUrl, "");
        }else{
    ...
    public void onResume() {
        ...
        IntentFilter filter = new IntentFilter("lsit.taxi.user.BookingDetailActivity");
